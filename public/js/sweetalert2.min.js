!(function (e, t) {
    ...
    const t = "SweetAlert2:",
        ...
        v = (e) => {
            ...
            for (const o in e)
                (n = o),
                    f(n) || r('Unknown parameter "'.concat(n, '"')),
                    e.toast &&
                        ((t = o),
                        h.includes(t) &&
                            r(
    ...
    const D = () => A(".".concat(w.loader)),
        ...
        F = () =>
            !K(document.body, w["toast-shown"]) &&
            !K(document.body, w["no-backdrop"]),
        U = () => B() && K(B(), w.toast);
    function W(e) {
    ...
    const z = { previousBodyPadding: null },
        _ = (t, e) => {
            if (((t.textContent = ""), e)) {
        ...
        Pe = (e, t) => {
            ...
            (t.showConfirmButton || t.showDenyButton || t.showCancelButton
                ...
                i.reverseButtons &&
                    (i.toast
                        ? (n.insertBefore(s, a), n.insertBefore(r, a))
                        : (n.insertBefore(s, o),
                          n.insertBefore(r, o),
                          n.insertBefore(a, o))),
                _(c, t.loaderHtml),
    ...
    function Be(e, t, n) {
        ie(e, n["show".concat(i(t), "Button")], "inline-block"),
            _(e, n["".concat(t, "ButtonText")]),
    ...
    const Ie = (e, t) => {
        ...
        Ve = (e, t) => {
            ...
            return n && t.icon === n.icon
                ? (Fe(e, t), void Ne(e, t))
                : t.icon || t.iconHtml
                ? t.icon && -1 === Object.keys(C).indexOf(t.icon)
                    ? (s(
                      ...
                      ne(e))
                    : (te(e), Fe(e, t), Ne(e, t), void $(e, t.showClass.icon))
                : ne(e);
        },
        Ne = (e, t) => {
        ...
        Ye = (e, t) => {
            ...
            t.toast
                ...
                ((e, t) => {
                    ...
                    if ((Y(e, t, "popup"), typeof t.customClass === "string"))
                        $(e, t.customClass);
        ...
        Qe = (e) => {
            ...
            return (
                a(e.querySelectorAll("swal-param")).forEach((e) => {
                    ...
                    "boolean" == typeof m[t] && "false" === e && (n[t] = !1),
                        "object" == typeof m[t] && (n[t] = JSON.parse(e));
                }),
                n
            );
        },
        ...
        ot = (e) => {
            ...
            t &&
                (rt(t, ["type", "label", "placeholder", "value"]),
    ...
    const ut = () => {
        ...
        pt = () => {
            ...
            ((/iPad|iPhone|iPod/.test(navigator.userAgent) &&
                ...
                (() => {
                    ...
                    if (o) {
                        const i = 44;
                        if (B().scrollHeight > window.innerHeight - i)
                            k().style.paddingBottom = "".concat(i, "px");
                    }
                })());
        },
        mt = (e) => {
        ...
        bt = (e, t) => {
            Ae && ce(t)
                ? ((e.style.overflowY = "hidden"), t.addEventListener(Ae, ft))
                ...
                "Enter" === t.key
                    ? ((o = e),
                      ...
                      (e = t).isComposing ||
                          (e.target &&
                              o.getInput() &&
                              e.target.outerHTML === o.getInput().outerHTML &&
    ...
    var Zt = Object.freeze({
        ...
        argsToParams: (n) => {
            const o = {};
            return (
                "object" != typeof n[0] || Ut(n[0])
                    ? ["title", "html", "icon"].forEach((e, t) => {
                          t = n[t];
                          "string" == typeof t || Ut(t)
                              ? (o[e] = t)
                              : void 0 !== t &&
                                s(
                                    "Unexpected type of "
        ...
        bindClickHandler: function () {
            var e =
                0 < arguments.length && void 0 !== arguments[0]
                    ...
                    : "data-swal-template";
            (Kt[e] = this),
                _t || (document.body.addEventListener("click", Yt), (_t = !0));
        },
    });
    function Jt() {
    ...
    function Gt(e) {
        ...
        var n = ((e) => {
            ...
            const o = k();
            return (
                G(o, n.showClass.backdrop),
                $(o, n.hideClass.backdrop),
                en(e, t, n),
                true
            );
        })(this);
        this.isAwaitingPromise()
            ? e.isDismissed || (Qt(this), t(e))
            : n && t(e);
    }
    const Qt = (e) => {
            e.isAwaitingPromise() &&
                (Ee.awaitingPromise.delete(e),
                Ee.innerParams.get(e) || e._destroy());
        },
        en = (e, t, n) => {
            var o,
                i,
            ...
            "function" == typeof n.willClose && n.willClose(t),
                s
                    ? ((o = e),
                      ...
                      (s = n.returnFocus),
                      (t = n.didClose),
                      (de.swalCloseEventFinishedCallback = $t.bind(
                          null,
                          o,
                          a,
                          s,
    ...
    const an = (e) => {
            e.isAwaitingPromise()
                ? (rn(Ee, e), Ee.awaitingPromise.set(e, !0))
                : (rn(Xt, e), rn(Ee, e));
        },
        rn = (e, t) => {
    ...
    e = Object.freeze({
        ...
        getInput: function (e) {
            ...
            return (e = Ee.domCache.get(e || this))
                ? Z(e.popup, t.input)
                : null;
        },
        close: Gt,
        ...
        showValidationMessage: function (e) {
            ...
            _(t.validationMessage, e),
                ...
                n.customClass &&
                    ...
                    $(t.validationMessage, n.customClass.validationMessage),
    ...
    class cn {
        ...
        _main(e) {
            ...
            v(Object.assign({}, t, e)),
                de.currentInstance &&
                    (de.currentInstance._destroy(), F() && $e()),
    ...
    const ln = (r, s, c) =>
            new Promise((e, t) => {
                ...
                var o, i, a;
                Xt.swalPromiseResolve.set(r, e),
                    Xt.swalPromiseReject.set(r, t),
                    (s.confirmButton.onclick = () =>
                        ((e) => {
                            var t = Ee.innerParams.get(e);
                            e.disableButtons(),
                                t.input ? xt(e, "confirm") : Lt(e, !0);
                        })(r)),
                    ...
                    (s.closeButton.onclick = () => n(Je.close)),
                    (o = r),
                    (e = s),
                    (t = n),
                    Ee.innerParams.get(o).toast
                        ? Ot(o, e, t)
                        : (Mt(e), Dt(e), It(o, e, t)),
                    (i = r),
                    (e = de),
                    ...
                    ((e) => {
                        ...
                        vt(t, n, e),
                            ...
                            F() && (yt(t, e.scrollbarPadding, o), Xe()),
                            U() ||
        ...
        un = (e, t) => {
            var n = ((e) => {
                ...
                return (
                    at(e),
                    Object.assign(Qe(e), et(e), tt(e), nt(e), ot(e), it(e, Ge))
                );
            })(e);
        ...
        gn = (e, t) =>
            t.focusDeny && ae(e.denyButton)
                ...
                : !(!t.focusConfirm || !ae(e.confirmButton)) &&
